...
class LayoutPlot(TreeLayout):
    def __init__(self, name=None, prop=None, width=200, size_prop=None, 
            ...
            position="aligned", column=0, padding_x=10, padding_y=0, size_range=[], size_range=[],
...
class LayoutBarplot(LayoutPlot):
    def __init__(self, name=None, prop=None, width=200, size_prop=None,
            ...
            internal_rep='avg', scale_size=None, size_range=None, size_range=None, scale_range=None):
